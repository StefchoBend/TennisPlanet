...
namespace TennisPlanet.Core.Services
{
    public class ProductItemService : IProductItemService
    {
        ...
        public bool Create(string itemName, int brandId, int categoryId, string picture, string description, decimal price, decimal discount)
        {
        ...
        public bool Update(int productItemId, string itemName, int brandId, int categoryId, string picture, string description, decimal price, decimal discount)
        {
            var productItem = GetProductItemById(productItemId);
            if (productItem == default(ProductItem))
            {
